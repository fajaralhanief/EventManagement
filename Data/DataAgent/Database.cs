...
namespace FRVN.Data.DataAgent
{
    public class Database
    {
        ...
        {
            //return new SqlConnection(ConfigurationManager.ConnectionStrings[ConfigurationManager.AppSettings["BiofarmaConnection"]].ToString());
            return new SqlConnection(ConfigurationManager.ConnectionStrings[@"Data Source=LAPTOP-DOPHK2QV;Initial Catalog=EVENT_PORTAL;Integrated Security=True"].ToString());
        }
