<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UpdateEvent.aspx.cs" Inherits="FRVN.Administrator.UpdateEvent" %>
                    ...
                    <div class="form-group">
                        <table style="margin-left:210px;">
                           <tr>
                            ...
                            <td class="auto-style1"><asp:TextBox ID="tanggalmulai" runat="server" class="form-control m-bot15" placeholder="Tanggal Mulai" Width="169px" required=""></asp:TextBox>
                            </td>
                            <td class="auto-style1"><asp:TextBox ID="tanggalselesai"   runat="server" class="form-control m-bot15" placeholder="Tanggal Selesai" Width="169px" required=""></asp:TextBox>
                            </td>
                           </tr>
                    ...
                    <div class="form-group" style="margin-top:25px;">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div align="center">
                                ...
                                <asp:LinkButton ID="LinkButton3" runat="server" CssClass="btn btn-primary" OnClick="LinkButton3_Click"><i class="fa fa-pencil-square-o" aria-hidden="true" style="font-size:16px;"></i>&nbsp;&nbsp;UPDATE</asp:LinkButton>
                                &nbsp;</div>
                        </div>
                    </div>
